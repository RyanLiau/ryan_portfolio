        ...
        <HeroContent>
          <div>
            ...
            <Subtitle role="heading" aria-level={3}>
              Creating images of the CIFAR 10 dataset
            </Subtitle>
            <Description role="paragraph">
              Utilizing a process of generating images and guessing their validity, by constantly feeding data into each other, a GAN model can create 
              realistic fake imaages
            </Description>
          </div>
        </HeroContent>
      </div>
