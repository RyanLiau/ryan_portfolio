        ...
        <HeroContent>
          <div>
            ...
            <Subtitle role="heading" aria-level={3}>
              Utilizing AI to help upskill users
            </Subtitle>
            <Description role="paragraph">
              A multi-group project that combines AI and Web Development to help users of PACE Academy select courses that are best suited for their ideal career goals
            </Description>
          </div>
        </HeroContent>
      </div>
