...
import step_img from "../../../assets/course_recommender/cr_4.png"
      ...
      <div className="container">
        ...
        >
          ...
          <ProjectCard 
            ...
            >
            <ProjectContent>
                <ProjectTitle id={`project-title-1`}>Deployment and Live Showcase</ProjectTitle>
                <ProjectDescription> 
                  To allow for client testing and prototype, the project was deployed using Google Cloud, a cloud computing service that helped host our database, APIs,
                   and frontend.
                </ProjectDescription>
